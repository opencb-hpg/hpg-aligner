...
vars.Add(PathVariable('EXTRAE_INCLUDE_PATH', 'Path to the headers of samtools library', '', PathVariable.PathAccept))
vars.Add(PathVariable('EXTRAE_LIBRARY_PATH', 'Path to the compiled samtools library', '', PathVariable.PathAccept))
...
env = Environment(tools = ['default', 'packaging'],
      		  CC = compiler,
                  ...
                  CPPPATH = ['#', '#src', '#include', '$SAMTOOLS_INCLUDE_PATH', '$CPROPS_INCLUDE_PATH', '$CONFIG_INCLUDE_PATH', '$ARGTABLE_INCLUDE_PATH', bioinfo_path, commons_path ],
                  LIBPATH = ['#libs/common-libs/', '$SAMTOOLS_LIBRARY_PATH', '$CPROPS_LIBRARY_PATH', '$CONFIG_LIBRARY_PATH', '$ARGTABLE_LIBRARY_PATH', commons_path ],
